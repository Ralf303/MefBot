...
1) +250 мефа к награде за актив(${fam.Baf.active}/5)

2) +1 к удаче(${fam.Baf.luck}/5)

3) +1% к успешному крафту(${fam.Baf.craft}/5)

4) +100 мефа к каждому сбору фермы(${fam.Baf.farm}/5)

5) +200 мефа к награде за ввод капчи(${fam.Baf.capcha}/5)

6) +500 мефа за приглашение юзера в чат(${fam.Baf.invite}/5)

7) +1 открытие кейса за одно открытие(${fam.Baf.case}/2)

Каждое улучшение стоит 1.000.000 мефа 🌿
